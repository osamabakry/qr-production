...
let SubscriptionGuard = class SubscriptionGuard {
    ...
    async canActivate(context) {
        ...
        if (!subscription) {
            throw new common_1.ForbiddenException('Subscription not found');
        }
        if (subscription.status !== 'ACTIVE') {
            throw new common_1.ForbiddenException('Subscription is not active. Please renew your subscription to access this feature.');
        }
